...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('css/videoLinkStyle4.css') }}" rel="stylesheet" type="text/css" >
  ...
  <body>
    ...
    <script> // ajax call to show method in VideoController
        $('#showModal').on('show.bs.modal', function (event) {
          var button = $(event.relatedTarget) // Button that triggered the modal
          var someId = button.data('whatever') // Extract info from data-* attributes
          ...
          var modal = $(this)
          modal.find('.modal-title').text('Selected id: ' + someId)
          modal.find('.modal-body').text('Author is: ' + author)
        })
    </script>
